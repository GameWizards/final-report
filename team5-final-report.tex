...
In addition, Anttris has an official game website! The website features explanations of the game rules, convenient download links, and screenshots of the game. The website was developed by us, and can be viewed by pointing a browser at

{\url{http://gamewizards.github.io}}
...
{\url{http://github.com/gamewizards/anttris/}}
...
\begin{figure}[H]
        ...
        \caption{Total commits sorted by additions. 'Trigition' is Skyler Manzanarez pushing from a friends computer.}\label{code:commitstats}
\end{figure}
